package org.lemo2.analysis.frequentpathviger;
...
@Instantiate
@Singleton
@Path("tools/frequentpathviger")
public class FrequentPathVigerAnalysis implements WebResource, AnalyticsTool {

	private static final Logger logger = LoggerFactory.getLogger(FrequentPathVigerAnalysis.class);

	@ServiceProperty(name = "lemo.tool.id")
	private String id = "frequentpathviger";

	@ServiceProperty(name = "lemo.tool.name")
	private String name = "Frequent Path Viger";
	...
	private final List<String> scripts;
	{
		...
		scripts.add("js/FrequentPathVigerData.js");
