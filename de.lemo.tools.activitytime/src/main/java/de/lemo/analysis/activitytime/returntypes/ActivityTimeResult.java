...
public class ActivityTimeResult {
	...
	public ActivityTimeResult(ResultListHashMapObject resultListHashMap) {
		...
		this.data[0] = new ActivityTimeList(result.subList(0, resultSize),"Course 1");
		this.data[1] = new ActivityTimeList(result.subList(resultSize, result.size()),"Course 1 User");
	}
